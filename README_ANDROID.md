...
* 视频相关
	...
	* [利用ffmpeg进行视频和音频的裁剪、转码、压缩处理](https://github.com/bhuvnesh123/FFmpeg-Video-Editor-Android)
...
* 插件合集
	...
	* [合集4](https://github.com/balsikandar/Android-Studio-Plugins)
* 插件查找
...
* [Android10.0通知Notification的使用这一篇就够了](https://my.oschina.net/u/4353713/blog/4254109)
...
* [获取设备id](https://gitee.com/li_yu_jiang/Android_CN_OAID)
